 ...
 */
async function createPassiveOffer(privKey, sellingCode, sellingIssuer, amount = '0', price, buyingCode = 'native', buyingIssuer = 'native', source = 'unsetted') {
return new Promise((resolve, reject) => {
        ...
        if (source === 'unsetted')
            des = StellarSdk.Keypair.fromSecret(privKey)
